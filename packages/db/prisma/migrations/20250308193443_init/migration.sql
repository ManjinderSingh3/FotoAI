-- CreateEnum
CREATE TYPE "GenderEnum" AS ENUM ('Man', 'Woman', 'Others');
...
-- CreateEnum
CREATE TYPE "EyeColorEnum" AS ENUM ('Brown', 'BlueHazel', 'Gray');
...
-- AddForeignKey
ALTER TABLE "TrainingImages" ADD CONSTRAINT "TrainingImages_trainModelId_fkey" FOREIGN KEY ("trainModelId") REFERENCES "TrainModel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OutputImages" ADD CONSTRAINT "OutputImages_trainModelId_fkey" FOREIGN KEY ("trainModelId") REFERENCES "TrainModel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
